...
<head>
    ...
    <title>ETML-LEDs-Inscription</title>
    <!-- CSS  -->
 ...
 * Author: carvalhoda
 * Date: 25.01.2016
 * Summary : Register page of the led project
 */
?>
    <div class="container">
        <?php
            ...
            if(isset($_GET['notInDb']))
            {
                ...
                echo $class->displayErrorSuccessAlert(0,"Votre adresse mail a déjà été validée ou ne figure pas dans la base de données !");
            }
            ...
            //If acc hasn't been activated
            if(isset($_GET['notActivated']))
            {
                //Display a danger message
                echo $class->displayErrorSuccessAlert(0,"Vous n'avez pas validé votre compte. Merci d'utiliser le formulaire ci-dessous !");
            }
            ...
            else
            {
                echo('
                    ...
                    <form data-toggle = "validator" role = "form" class="form-signin" method = "POST" action = "registerPagePost.php" >
