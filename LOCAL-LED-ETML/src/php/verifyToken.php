...
<head>
    ...
    <title>ETML-LEDs-Choix mot de passe</title>
    <!-- CSS AMD JAVASCRIPT -->
 ...
 * Author: carvalhoda
 * Date: 25.01.2016
 * Summary : Page to validate the account
 */
//Include the class
...
<div class="container">
    <?php
            ...
            if(isset($_GET['id'],$_GET['token']))
            {
                ...
                if ($class->accAlreadyActivated($_SESSION["idToConfirm"]))
                {
                    ...
                    else
                    {
                        echo "
                         <div class='alert alert-warning'>
                          ...
                          <strong>Presque !</strong> Pour valider votre inscription merci de choisir votre mot de passe !
                           </div>
                         ";
                        echo '
                        <form data-toggle="validator" role="form" class="form-signin" method="POST" action="verifyTokenPost.php">
                            <h2 class="form-signin-heading">Choix du mot de passe</h2>
                             ...
                             <div class="form-group">
                                <label for="confirmPW" class="control-label">Confirmer mot de passe:</label>
                            ...
                            <div class="center-align">
                                <button class="btn btn-lg btn-primary btn-block" type="submit">Valider l\'inscription</button>
                            </div>
                        </form>
                        ';
                    }
